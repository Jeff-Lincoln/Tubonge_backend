...
SECRET_KEY = getenv('SECRET_KEY', 'your-default-secret-key')  # Load from .env

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = getenv('DEBUG', 'True') == 'True'  # Load from .env

# Allow all hosts (suitable for development)
...
DATABASES = {
    'default': {
        ...
        'NAME': tmpPostgres.path.replace('/', ''),  # Extracts the DB name
        'USER': tmpPostgres.username,               # Extracts the username
        'PASSWORD': tmpPostgres.password,           # Extracts the password
